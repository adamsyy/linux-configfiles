  ...
  window.JEEFACEFILTERAPIGEN = function () {
        ...
        -1 !== X.nDetectsPerLoop
          ...
          : ((a = I.Ta),
            ...
            P.ia > I.ea[1]
              ? ((a = I.za[1]),
                1 < E.i &&
                  (++a, (c = ma.filter(Pb).length), (a *= Math.max(1, c))),
                (P.G = Math.min(P.G + 1, a)),
                (P.ia = (I.ea[0] + I.ea[1]) / 2))
              : P.ia < I.ea[0] &&
                ((P.G = Math.max(P.G - 1, I.za[0])),
                (P.ia = (I.ea[0] + I.ea[1]) / 2)));
        ra.F();
    ...
    function Ub() {
      return Ua.some(function (a, c) {
        if (c === E.Z) return !1;
        c = Ua[E.Z];
        if (c.La > a.La || 3 > a.La || Fb(c.x, c.T, a.x, a.T) < I.cc * c.T)
          return !1;
        var d = V.M / V.O;
    ...
    var pa = {
      ...
      Aa = (function () {
        ...
        var d = null,
          ...
          y = {
            ...
            o: function (m) {
              m.Uc && !m.Ua
                ? (d = document.getElementById(m.Uc))
                : m.Ua && (d = m.Ua);
          ...
          B = {
            ...
            instance: function (q) {
              ...
              var ta = b.createTexture(),
                ...
                va = h.isFlipY,
                Ja =
                  h.H && h.isMipmap && "undefined" !== typeof Va && !Va.Lc()
                    ? !0
                    : !1,
                Sa = null,
                fb = -1,
      ...
      Va = (function () {
        ...
        function c(z) {
          return Z.Db() && a(m, b.FLOAT, new Float32Array(p), z)
            ? ((k = f.yb), !0)
            : !1;
        }
        function d(z) {
          return Z.Kc()
            ? a(r, Z.Fa(), new Uint16Array(p), z) ||
              a(r, b.FLOAT, new Float32Array(p), z)
              ? ((k = f.Ra), !0)
              : !1
            : !1;
        }
    ...
    var V = null,
      ...
      Kb = {
        ...
        init: function (a) {
          ...
          for (var d = 0; d < E.i; ++d)
            rb.push(new Float32Array(I.Ad)), sb.push(0);
